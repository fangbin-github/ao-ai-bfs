...
import gov.cnao.ao.ai.bfs.controller.DictTypeController;
...
public class DictTypeService {
	...
	private final static org.slf4j.Logger log = LoggerFactory.getLogger(DictTypeService.class);
...
//				object.put("children", c.getDictTypeNm());
	...
	public BaseResponse<DictTypeVO> insertDictType(DictTypeVO dictTypeVO) {
		...
		try {
			...
			client.set(dictTypeVO.getDictTypeId(), dictTypeVO.getDictTypeNm());
//			System.out.println(client.get(dictTypeVO.getDictTypeId()) + "===========================================");
